...
#include "JH_RollBall/FloatingActor.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeFloatingActor() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	ENGINE_API UClass* Z_Construct_UClass_UStaticMeshComponent_NoRegister();
	JH_ROLLBALL_API UClass* Z_Construct_UClass_AFloatingActor();
	JH_ROLLBALL_API UClass* Z_Construct_UClass_AFloatingActor_NoRegister();
...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_RotatingSpeed_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_RotatingSpeed;
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloatingActor_Statics::NewProp_FloatSpeed = { "FloatSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFloatingActor, FloatSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingActor_Statics::NewProp_FloatSpeed_MetaData), Z_Construct_UClass_AFloatingActor_Statics::NewProp_FloatSpeed_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingActor_Statics::NewProp_RotatingSpeed_MetaData[] = {
		{ "Category", "FloatingActor" },
		{ "ModuleRelativePath", "FloatingActor.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloatingActor_Statics::NewProp_RotatingSpeed = { "RotatingSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFloatingActor, RotatingSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingActor_Statics::NewProp_RotatingSpeed_MetaData), Z_Construct_UClass_AFloatingActor_Statics::NewProp_RotatingSpeed_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFloatingActor_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFloatingActor_Statics::NewProp_RotatingSpeed,
	};
	...
	template<> JH_ROLLBALL_API UClass* StaticClass<AFloatingActor>()
	{
		return AFloatingActor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AFloatingActor);
	AFloatingActor::~AFloatingActor() {}
	struct Z_CompiledInDeferFile_FID_JinHyung_Programming_GameProject_UE_Hugh_JH_RollBall_Source_JH_RollBall_FloatingActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_JinHyung_Programming_GameProject_UE_Hugh_JH_RollBall_Source_JH_RollBall_FloatingActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AFloatingActor, AFloatingActor::StaticClass, TEXT("AFloatingActor"), &Z_Registration_Info_UClass_AFloatingActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFloatingActor), 1588500969U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_JinHyung_Programming_GameProject_UE_Hugh_JH_RollBall_Source_JH_RollBall_FloatingActor_h_937113565(TEXT("/Script/JH_RollBall"),
		Z_CompiledInDeferFile_FID_JinHyung_Programming_GameProject_UE_Hugh_JH_RollBall_Source_JH_RollBall_FloatingActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_JinHyung_Programming_GameProject_UE_Hugh_JH_RollBall_Source_JH_RollBall_FloatingActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
